...
namespace Triangle.Compiler.CodeGenerator
{
    public partial class Encoder
    {
        ...
        public int VisitEmptyParameterSequence(EmptyParameterSequence ast, Frame frame)
        {
            return 0;
        }

        public int VisitSingleParameterSequence(SingleParameterSequence ast, Frame frame)
        {
            return ast.Parameter.Visit(this, frame);
        }
